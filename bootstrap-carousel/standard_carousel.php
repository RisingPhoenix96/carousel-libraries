...
<div class="page-wrap">
    ...
    <div id="carouselExampleControlsMulti" class="carousel slide carousel-multi-item" data-ride="carousel">
        ...
        <a class="carousel-control-prev bootstrap-side-prev bootstrap-side-translucent" href="#carouselExampleControlsMulti" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="carousel-control-next bootstrap-side-next bootstrap-side-translucent" href="#carouselExampleControlsMulti" role="button" data-slide="next">
